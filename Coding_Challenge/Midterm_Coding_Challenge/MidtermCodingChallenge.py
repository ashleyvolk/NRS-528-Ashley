# Midterm Tool Challenge (due Friday 17th March 17.30pm)
...
# and exporting data. The exact workflow is entirely up to yourself.
# You are expected to take 3-4 hours on this coding assignment, and you should deposit your code and example
# files within a Github repository for feedback and grading.
#
# The criteria are:
#
...
# In addition, you must provide example data and minimize the amount of editing a user must make in order
# for the program to run (10 points).
