...
#
# Set up the tool to run in Python, add some useful comments,
# and importantly, provide some example data in your repository
...
arcpy.env.workspace = r"E:\NRS_528_Ashley\Coding_Challenge_4"
...
out_feature_class = r"Washington_town.shp"
